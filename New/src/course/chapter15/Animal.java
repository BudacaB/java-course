...
public class Animal {
    ...
    public Animal(String species, String name, boolean friendly, int weight) {
    ...
    public static void main(String[] args) {
        ...
        try {
            FileOutputStream dat = new FileOutputStream("/home/bogdan/Coding/java-course/New/src/course/chapter15/Animal.dat");
            scrappy.writeBinary(dat);
            hobbes.writeBinary(dat);
            scar.writeBinary(dat);
            dat.close();

            FileWriter txt = new FileWriter("/home/bogdan/Coding/java-course/New/src/course/chapter15/Animal.txt");
